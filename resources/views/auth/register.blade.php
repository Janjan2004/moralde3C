...
@section('content')
<div class="container-fluid" style="background: linear-gradient(135deg, #6e7bff, #96d38c); height: 100vh;">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus style="border-radius: 20px;">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4 text-center">
                                <button type="submit" class="btn btn-primary btn-block px-4 py-2 rounded-3" style="background-color: #4e73df; border-color: #4e73df; transition: background-color 0.3s ease;">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
